...
public class StreamsTest {
    ...
    public void countEvenNumbers() {
        ...
        long result = Stream.of(PI).filter(e -> e % 2 == 0).count();
    ...
    public void sumOddNumbers() {
        ...
        int result = Stream.of(PI).filter(e -> e % 2 == 1).reduce(0, Integer::sum);
    ...
    public void calculateTax() {
        ...
        Double result = Stream.of(prices).map(e -> e * (1 + tax)).reduce(0.0, Double::sum);
    ...
    public void sumStringIntegers() {
        ...
        int result = Stream.of(input).map(Integer::parseInt).reduce(0, Integer::sum);
    ...
    public void streamOfStreams() {
        ...
        int result = Stream.of(input)
                .map(e -> Arrays.stream(e).sum()) // Sum the int[]s
                .reduce(0, Integer::sum);  // Sum the result of those sums
    ...
    public void philosophers() {
        ...
        Map<String,String> result = philosophers.entrySet().stream()
                .filter(e -> Objects.equals(e.getValue(), "Greek"))
